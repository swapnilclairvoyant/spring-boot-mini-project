...
@Configuration
@EnableJpaRepositories(basePackages="com.clairvoyant.mvc.repositories", entityManagerFactoryRef="entityManagerFactory", transactionManagerRef="transactionManager")
@EnableTransactionManagement
public class JpaCnfiguration {
	@Autowired
	...
	///////Configuring HikariCP pool DataSource
	@Bean
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.clairvoyant.mvc.model" });
